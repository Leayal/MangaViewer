...
using MSVisualTreeHelper = System.Windows.Media.VisualTreeHelper;
...
namespace VisualHelper
{
    public static class VisualTreeHelper
    {
        ...
        {
            current = MSVisualTreeHelper.GetParent(current);
        ...
        where T : DependencyObject
        {
            ...
            int childrenCount = MSVisualTreeHelper.GetChildrenCount(parent);
            for (int i = 0; i < childrenCount; i++)
            {
                var child = MSVisualTreeHelper.GetChild(parent, i);
